function Timeline(cvs) {
  ...
  self.dotColors = [
    ...
    ["#946c94", "rgba(113, 22, 15, 0.3)", "rgba(91, 64, 222, 0.12)"],
  ];
...
$(document).ready(function () {
  // Your provided jQuery code here
  (function ($) {
...
// ANIMATE ON NAP: 
// const birdsAnimation = document.getElementById("right-bird");

// birdsAnimation.addEventListener("mouseenter", () => {
//   birdsAnimation.play(); // Play the animation on hover
// });

// birdsAnimation.addEventListener("mouseleave", () => {
//   birdsAnimation.pause(); // Pause the animation when the mouse leaves
// });

// birdsAnimation.addEventListener("animationComplete", () => {
//   birdsAnimation.goToAndStop(0); // Reset the animation to the beginning when it completes
// });
